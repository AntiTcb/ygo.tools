...
class DamageCalculator {
  ...
  calculateBattleDamage() {
    const result = {
      ...
      let aDamage = 0, bDamage = 0, aRedirectedDamage = 0, bRedirectedDamage = 0, aEffectDamage = 0, bEffectDamage = 0;
      ...
      if (damageAmount < 0) {
        ...
        bDamage = isPiercedAttack ? damageAmount : this.attackingMonster.position === 'ATK' && this.defendingMonster.position === 'ATK' ? damageAmount : 0;
      }
